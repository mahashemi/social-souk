...
<tr><td align="center">
<table width="480" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e2ddd6;max-width:480px;">
<tr><td style="background:#0a3d1f;padding:24px 32px;text-align:center;">
<span style="font-size:22px;color:#d4af5a;font-weight:bold;">🛍️ {$siteSafe}</span>
</td></tr>
<tr><td style="padding:32px;">
<p style="font-size:16px;color:#1a1a1a;margin:0 0 16px;">Assalamu Alaikum {$nameSafe},</p>
<p style="font-size:15px;color:#444444;line-height:1.6;margin:0 0 28px;">Thank you for joining {$siteSafe}. Please confirm your email address to activate your account and start trading with barakah.</p>
<table cellpadding="0" cellspacing="0" style="margin:0 auto 28px;">
<tr><td style="border-radius:25px;background:#1a5c33;">
...
<p style="font-size:13px;margin:0 0 24px;"><a href="{$link}" style="color:#1a5c33;word-break:break-all;">{$link}</a></p>
...
<tr><td style="background:#faf7f2;padding:16px 32px;text-align:center;border-top:1px solid #e2ddd6;">
